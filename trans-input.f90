program trans
  ...
  double precision l0,l1,l2,m1,m2,m0,n0,n1,n2
  ...
  integer i, ngrain
   ...
   72  format(i5,3(1x,f10.5)," # number of grains, box-x, box-y, box-z")
    ...
    read(101,*)
    write(102,*)lat
    write(102,72)ngrain,b0(1,1),b0(2,2),b0(3,3)
    WRITE(102,*)'0.0 1.0'	
    ...
    do i=1,ngrain
     ...
     cosa2=sin(phi2)*sin(phi1)
     cosa3=cos(phi1)
     cosb1=(cosa1*cosa1+(cosa2*cosa2+cosa3*cosa3)*cos(phi3))*(-1.0)*sin(phi2)+(cosa1*cosa2*(1-cos(phi3))-cosa3*sin(phi3))*cos(phi2);
     cosb2=(cosa1*cosa2*(1-cos(phi3))+cosa3*sin(phi3))*(-1.0)*sin(phi2)+(cosa2*cosa2+(cosa1*cosa1+cosa3*cosa3)*cos(phi3))*cos(phi2);
     cosb3=(cosa1*cosa3*(1-cos(phi3))-cosa2*sin(phi3))*(-1.0)*sin(phi2)+(cosa2*cosa3*(1-cos(phi3))+cosa1*sin(phi3))*cos(phi2);
     cosr1=cosa2*cosb3-cosa3*cosb2;
     cosr2=-1.0*cosa1*cosb3+cosa3*cosb1;
     cosr3=cosa1*cosb2-cosa2*cosb1;

     l0=cosa1;m0=cosa2;n0=cosa3;
     l1=cosb1;m1=cosb2;n1=cosb3;
     l2=cosr1;m2=cosr2;n2=cosr3;

     cosa1=l0;cosa2=l1;cosa3=l2;
     cosb1=m0;cosb2=m1;cosb3=m2;
     cosr1=n0;cosr2=n1;cosr3=n2;
    ...
    BC(i)=255
     ...
     write(102,2001)x,y,z,phi(i),thida(i),kosin(i)
2001 format(6(1x,f10.5))
